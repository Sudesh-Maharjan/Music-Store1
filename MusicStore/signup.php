...
<form action="registration.php" method = "post">
    <div class="signup-page">
        ...
        <div class="input-boxes">
            <div class="F-name"> <div class="signup-icon"><i class="fas fa-user"></i></div>
           ...
           <div class="signup-radio"><i class="fas fa-venus-mars"></i></div> <div class="gender"> Male<input class="radio" value="male" name="gender" type="radio">Female<input class="radio" value="female" name="gender" type="radio"></div>
            ...
            <!-- country selector -->
            <select class="input"  placeholder="Country" name = "country">
            ...
            <div class="State"><div class="signup-icon"><i class="fas fa-gopuram"></i></div><input class="input" type="text"placeholder="State" name = "state"></div>
            ...
            <div class="register-signup"><button class="input-a" name ="register">Register</button></div>
        </div>
    </div>
</form>
</body>
